      ...
      <div className="relative hidden lg:block bg-black">
        ...
        <div className="absolute bottom-12 left-12 right-12 z-10">
          ...
          <p className="text-neutral-500 text-sm max-w-sm">
            Join thousands of users predicting live matches and winning real
            rewards on the Solana network.
          </p>
        </div>
      </div>
        ...
        <div className="relative z-10 w-full max-w-md mx-auto space-y-8">
          ...
          <div className="text-center pt-4">
            <p className="text-slate-500 text-sm">
              ...
              <Link
                href="/auth/register"
                className="text-white hover:text-blue-400 font-medium transition-colors opacity-50 pointer-cursor"
                aria-disabled="true"
                tabIndex={-1}
              >
                Sign up free
