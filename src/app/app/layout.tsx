...
import { Home, PlusSquare, Radio, User, Settings, LogOut, X, Heart, Video } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-100">
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          />
          <aside className="absolute top-0 bottom-0 left-0 w-64 bg-[#0a0a0a] border-r border-white/5 p-4 animate-in slide-in-from-left duration-200">
